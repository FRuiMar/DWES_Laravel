<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            ...
            <x-text-input id="dni" class="block w-full mt-1" type="text" name="dni" :value="old('dni')" required
        ...
        <div>
            ...
            <x-text-input id="especialidad" class="block w-full mt-1" type="text" name="especialidad"
