                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                ...
                                <div class="mt-2">
                                    <p class="text-sm text-gray-500 dark:text-gray-400">
                                        ...
                                        "{{ $membershipToDelete->type ?? '' }}"?
                                        @if ($membershipToDelete && $membershipToDelete->users_count > 0)
                                            <span class="font-bold text-red-500 dark:text-red-400">Esta membresía tiene
                                                {{ $membershipToDelete->users_count }} usuarios asignados</span> que
                                            serán movidos a "Sin membresía".
                                        @endif
